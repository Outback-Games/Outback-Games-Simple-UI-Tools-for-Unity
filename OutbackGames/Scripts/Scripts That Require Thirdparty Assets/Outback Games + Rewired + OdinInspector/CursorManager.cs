...
namespace OutbackGames.UI.Tools.MultiThirdParty
{
    public class CursorManager : MonoBehaviour
    {
        [BoxGroup("Cursor Image Settings"), SerializeField, Tooltip("Cursor For Overworld")]
        Texture2D overworldCursor;

        [BoxGroup("Cursor Image Settings"), SerializeField, Tooltip("Ui Cursor\nLeave empty to use system default.")]
        Texture2D uiCursor;
        
        [BoxGroup("Cursor Image Settings"), SerializeField, Tooltip("Default Cursor for the Scene\nLeave empty to use system default.")]
        Texture2D defaultCursorImage;

        [BoxGroup("Cursor Image Settings"), SerializeField, Tooltip("Cursor Hotspot")]
        Vector2 cursorHotspot = Vector2.zero;

        [BoxGroup("Change Cursor Image Conditions"),SerializeField, Tooltip("Objects To Cause Default Change")]
        GameObject[] changeToUiCursorObjects;

        [BoxGroup("Polling Settings"),SerializeField, Tooltip("Delay Between Change Checks\nUse this if you want a shorter or longer wait between cursor changes"), Range(0.01f, 2.5f)]
        float unscaledChangeInterval = 0.25f;
        int objOnCount = 0;
        [BoxGroup("Polling Settings"),SerializeField,Tooltip("The amount of time to wait before unlocking the mouse while loading in.")]
        float timeToInitialize = 2f;
        
        [SerializeField, BoxGroup("Rewired Gamepad Settings")]
        string playerID = "DefaultPlayer";
        [SerializeField, ReadOnly, BoxGroup("Rewired Gamepad Settings")]
